                    ...
                    {SOCIAL_LINKS.map((link) => {
                        ...
                        return (
                            <a
                                ...
                                target="_blank"
                                rel="noopener"
                                className={`flex items-center gap-2 hover:text-zinc-900 dark:hover:text-white transition-all duration-300 group relative ${isEmail ? 'hover:bg-zinc-100 dark:hover:bg-zinc-800 px-3 py-2 rounded-full -ml-3' : ''}`}
                            >
